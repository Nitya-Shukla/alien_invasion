...
class AlienInvasion :
    ...
    def _update_bullets(self):
        """Update the position of all bullets and delete the old ones"""
        self.bullets.update()
    ...
    def _update_screen(self):
        ...
        #Draw thhe play button if game is inactive 
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            #Get ris of any remaining aliens and bullets 
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                #Treat this the same as if the shipgot hit.
                self._ship_hit()
                break
